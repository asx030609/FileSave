...
go
----正常情况下是一架一层最多32位，但是用友上尽然可以到58
----1-N架，1-M层，N、M已经固定，要在这固定的基础上添加33-58位
----找出N、M
create PROC pro_001
AS
BEGIN
	...
	begin
		...
		begin
			...
			set @i_Place = @i_BeginPlace;print(@i_BeginPlace);
			...
			begin
				...
				--VALUES (@v_LocationCode, @v_LocationCode, 2, 'MDJ-BJK', 'LS', 'LS-'+@v_Jia, '', '', 0, 0, '', '', 300, 30, 0, 0, 1, 0, '', 1, 1, 0, 0, 1, '', '', 0, 0, '', '', SYSDATETIME()
	...
	VALUES ('01-65-33', '01柜-65层-33位', 0, 'MDJ-BJK', 'ACS', 'ACS001R01-01', '', '', null, null, null, null, 5000, 1, 0, 0
