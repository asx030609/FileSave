...
*/
----////如果移交时能够物料数量全部都为0，要查找这些方便修改
SELECT * FROM WM_MACHINE_HANDOVERU WHERE MACHINE_CODEU='J106';
SELECT * FROM WM_MACHINE_HANDOVER_DETAILU  WHERE TRANSFER_BILL_NOU IN (SELECT TRANSFER_BILL_NOU FROM WM_MACHINE_HANDOVERU WHERE MACHINE_CODEU='J106') ORDER BY CREATE_TIMEU DESC;
SELECT * FROM WM_MACHINE_HANDOVER_DETAILU  WHERE TRANSFER_BILL_NOU IN (SELECT TRANSFER_BILL_NOU FROM WM_MACHINE_HANDOVERU WHERE MACHINE_CODEU='J106' AND NEXT_PLANU IS NULL);
SELECT * FROM WM_MACHINE_PALLET_DETAILU  WHERE MACHINE_CODEU='J106';
UPDATE WM_MACHINE_HANDOVER_DETAILU SET TRANSFER_QUANTITYU='6500',RECEIVE_QUANTITYU='6500' WHERE IDU IN ('4175F6B180879F4780F6132416F75776', '27E740C1FB58204CBAB413E54C601910');
UPDATE  WM_MACHINE_PALLET_DETAILU SET TOTAL_QUANTITYU='6500'  WHERE MACHINE_CODEU='J106' AND IDU IN ('F8E53E88E5589F409C46BAC952C271BB');
----////
