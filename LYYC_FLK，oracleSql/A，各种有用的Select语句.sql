...
SELECT * FROM WM_MACHINE_HANDOVERU WHERE MACHINE_CODEU='B202';
SELECT * FROM WM_MACHINE_HANDOVER_DETAILU  WHERE TRANSFER_BILL_NOU IN (SELECT TRANSFER_BILL_NOU FROM WM_MACHINE_HANDOVERU WHERE MACHINE_CODEU='B202' AND NEXT_PLANU IS NULL);
SELECT * FROM WM_MACHINE_HANDOVER_DETAILU  WHERE TRANSFER_BILL_NOU IN (SELECT TRANSFER_BILL_NOU FROM WM_MACHINE_HANDOVERU WHERE MACHINE_CODEU='B202' AND NEXT_PLANU IS NULL) AND PRODUCT_CODEU='03070200000000014';
SELECT * FROM WM_MACHINE_PALLET_DETAILU  WHERE MACHINE_CODEU='B202';
----////
