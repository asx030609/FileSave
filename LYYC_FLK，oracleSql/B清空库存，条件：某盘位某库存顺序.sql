...
BEGIN
    ...
    UPDATE WM_PALLETU SET MATCH_PALLET_CODEU='', MATCH_PALLET_NAMEU='',UNIQUE_IDU='',PRODUCT_COUNTU=0,STORAGE_QUANTITYU=0,IN_FROZEN_QUANTITYU=0,OUT_FROZEN_QUANTITYU=0
        ...
        WHERE LOCATION_CODEU=V_LOCATION_CODEU AND STORAGE_SEQUENCEU=I_STORAGE_SEQUENCEU;
    --删除机组中的库存Storage信息
    DELETE FROM WM_STORAGEU WHERE PALLET_IDU IN (SELECT IDU FROM WM_PALLETU WHERE LOCATION_CODEU=V_LOCATION_CODEU AND STORAGE_SEQUENCEU=I_STORAGE_SEQUENCEU);
