...
INSERT INTO A_TB_TEST(IIndex, COL01, COL02, COL03, COL04) VALUES(SEQ_AUTO_INCRMENT_ONE.NEXTVAL, 'A1', 'B1', 'C1', 'D1');
INSERT INTO A_TB_TEST(IIndex, COL01, COL02, COL03, COL04) VALUES(SEQ_AUTO_INCRMENT_ONE.NEXTVAL, 'A1', 'B1', 'C1', 'D1A');
INSERT INTO A_TB_TEST(IIndex, COL01, COL02, COL03, COL04) VALUES(SEQ_AUTO_INCRMENT_ONE.NEXTVAL, 'A1', 'B1', 'C1', 'D1-1');
INSERT INTO A_TB_TEST(IIndex, COL01, COL02, COL03, COL04) VALUES(SEQ_AUTO_INCRMENT_ONE.NEXTVAL, 'A1', 'B1', 'C1', 'D1-2');
INSERT INTO A_TB_TEST(IIndex, COL01, COL02, COL03, COL04) VALUES(SEQ_AUTO_INCRMENT_ONE.NEXTVAL, 'A1', 'B1', 'C1', 'D2A');
INSERT INTO A_TB_TEST(IIndex, COL01, COL02, COL03, COL04) VALUES(SEQ_AUTO_INCRMENT_ONE.NEXTVAL, 'A1', 'B1', 'C1', 'DA1');
INSERT INTO A_TB_TEST(IIndex, COL01, COL02, COL03, COL04) VALUES(SEQ_AUTO_INCRMENT_ONE.NEXTVAL, 'A1', 'B1', 'C1', 'DA2');
...
UPDATE A_TB_TEST SET COL01 = 'UP_0000', COL02='UP_0001' WHERE COL04='D1-1' AND COL03='C1';
COMMIT;


SELECT * FROM A_TB_TEST;
SELECT COL01,COL02,COL03,COL04 FROM A_TB_TEST GROUP BY COL01,COL02,COL03,COL04;
SELECT * FROM A_TB_TEST ORDER BY COL04;
