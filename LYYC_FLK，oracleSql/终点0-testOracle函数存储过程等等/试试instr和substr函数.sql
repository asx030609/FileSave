...
select substr('11,222,3333,44444', 0, 3) AB from dual; --11,
select substr('11,222,3333,44444', 1, 3) AB from dual; --11,
select substr('11,222,3333,44444', 2, 3) AB from dual; --1,2
