...
SELECT * FROM WM_PRODUCTION_PLAN_DETAILU
  ...
  BETWEEN to_date('2020/09/25 0:00:00', 'yyyy-mm-dd hh24:mi:ss') AND to_date('2020/09/26 0:00:00', 'yyyy-mm-dd hh24:mi:ss'))
  AND TEAM_CODEU LIKE '%2%'
  AND MACHINE_CODEU LIKE '%06%'
  ORDER BY MACHINE_NAMEU, CREATE_TIMEU DESC;
SELECT * FROM WM_PRODUCTION_PLAN_DETAILU
  WHERE PRODUCTION_PLAN_NOU IN (SELECT PRODUCTION_PLAN_NOU FROM WM_PRODUCTION_PLANU WHERE WM_PRODUCTION_PLANU.AUDIT_TIMEU 
  BETWEEN to_date('2020/09/28 0:00:00', 'yyyy-mm-dd hh24:mi:ss') AND to_date('2020/09/29 0:00:00', 'yyyy-mm-dd hh24:mi:ss'))
  AND TEAM_NAMEU LIKE '%甲班%'
  AND MACHINE_CODEU LIKE '%05%'
  ORDER BY MACHINE_NAMEU, CREATE_TIMEU DESC;
-----//////////////
...
SELECT * FROM WM_MANUAL_MATERIAL_BILL_DETAILU WHERE PRODUCTION_PLAN_NOU='P202009030015';
----盘点单据
...
SELECT * FROM SYS_PARAMETERU WHERE PARAMETER_NAMEU LIKE '%IsCheck%';
SELECT * FROM WM_PRODUCTION_PLANU;
SELECT * FROM WM_PRODUCTION_PLAN_DETAILU;