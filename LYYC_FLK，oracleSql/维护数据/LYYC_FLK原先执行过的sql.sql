...
----产品信息
SELECT * FROM BI_PRODUCT_UNITU WHERE PRODUCT_CODEU='03060100000000029';
...
SELECT * FROM WM_PRODUCTION_PLAN_DETAILU
  WHERE PRODUCTION_PLAN_NOU IN (SELECT PRODUCTION_PLAN_NOU FROM WM_PRODUCTION_PLANU WHERE WM_PRODUCTION_PLANU.AUDIT_TIMEU BETWEEN to_date('2020/09/11 0:00:00', 'yyyy-mm-dd hh24:mi:ss') AND to_date('2020/09/14 0:00:00', 'yyyy-mm-dd hh24:mi:ss'))
