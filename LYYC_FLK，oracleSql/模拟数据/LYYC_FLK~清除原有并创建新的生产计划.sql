...
values ( SYS_GUID(),  'P202004190002' ,  '1' ,  '1' ,  '甲班' , null, null,  'Z304' ,  '4#装封箱机' ,  '69010281666900001' ,  '红旗渠（天行健）' , null,  '0' , null, null,  SYSDATE ,  SYSDATE ,  SYS_GUID());

insert into "C##FUSION"."WM_PRODUCTION_PLAN_DETAILU"("IDU", "PRODUCTION_PLAN_NOU", "SERIAL_NUMBERU", "TEAM_CODEU", "TEAM_NAMEU", "SHIFT_CODEU", "SHIFT_NAMEU", "MACHINE_CODEU", "MACHINE_NAMEU", "BRAND_CODEU", "BRAND_NAMEU", "ORIGIN_WORK_NOU", "PRODUCTION_PLAN_DETAIL_STATUSU", "PRODUCTION_BEGIN_TIMEU", "PRODUCTION_END_TIMEU", "CREATE_TIMEU", "UPDATE_TIMEU", "ROW_VERSIONU")
values ( SYS_GUID(),  'P202004190002' ,  '1' ,  '1' ,  '甲班' , null, null,  'J104' ,  '4#卷接机' ,  '69010281666900001' ,  '红旗渠（天行健）' , null,  '0' , null, null,  SYSDATE ,  SYSDATE ,  SYS_GUID());

insert into "C##FUSION"."WM_PRODUCTION_PLAN_DETAILU"("IDU", "PRODUCTION_PLAN_NOU", "SERIAL_NUMBERU", "TEAM_CODEU", "TEAM_NAMEU", "SHIFT_CODEU", "SHIFT_NAMEU", "MACHINE_CODEU", "MACHINE_NAMEU", "BRAND_CODEU", "BRAND_NAMEU", "ORIGIN_WORK_NOU", "PRODUCTION_PLAN_DETAIL_STATUSU", "PRODUCTION_BEGIN_TIMEU", "PRODUCTION_END_TIMEU", "CREATE_TIMEU", "UPDATE_TIMEU", "ROW_VERSIONU")
values ( SYS_GUID(),  'P202004190002' ,  '1' ,  '1' ,  '甲班' , null, null,  'B204' ,  '4#包装机' ,  '69010281666900001' ,  '红旗渠（天行健）' , null,  '0' , null, null,  SYSDATE ,  SYSDATE ,  SYS_GUID());
