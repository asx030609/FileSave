...
is
  ...
  V_B VARCHAR2(100);
begin
----1）在网页上手动删除更快，先删除除03140100000000248 硬盒简化循环烟箱 这个之外的那三个新箱皮
----2）使用如下sql语句添加这三个产品编码以及其产品单位

insert into "C##FUSION"."BI_PRODUCTU"("PRODUCT_CODEU", "PRODUCT_NAMEU", "PRODUCT_NOU", "FULL_PHONETICIZEU", "SHORT_PHONETICIZEU", "DISPLAY_ORDERU", "UNIFORM_CODEU", "FACTURER_CODEU", "CARGO_OWNER_CODEU", "ABNORMITYU", "LENGTHU", "WIDTHU", "HEIGHTU", "ACTIVEU", "IS_BIG_PRODUCTU", "SORT_NOU", "REMARKU", "PRODUCT_CATEGORY_CODEU", "PRODUCT_BREED_CODEU", "PRODUCT_PATTERN_CODEU", "PRODUCT_GRADE_CODEU", "PRODUCT_ORIGIN_CODEU", "YEARU", "WEIGHTU", "PACK_TYPEU", "CREATE_TIMEU", "UPDATE_TIMEU", "ROW_VERSIONU")
values ( 'HQQMGSCYX' ,  '硬盒简化循环烟箱（芒果）' ,  '0' ,  'YingHeJianHuaXunHuanYanXiangMangGuo' ,  'YHJHXHYXMG' ,  '0' ,  '' ,  '' , null,  '0' ,  '0' ,  '0' ,  '0' ,  '1' ,  '0' ,  '0' ,  '' ,  '' ,  '' ,  '' ,  '' ,  '' ,  '' ,  '0', 0 ,  SYSDATE ,  SYSDATE ,  SYS_GUID());

insert into "C##FUSION"."BI_PRODUCTU"("PRODUCT_CODEU", "PRODUCT_NAMEU", "PRODUCT_NOU", "FULL_PHONETICIZEU", "SHORT_PHONETICIZEU", "DISPLAY_ORDERU", "UNIFORM_CODEU", "FACTURER_CODEU", "CARGO_OWNER_CODEU", "ABNORMITYU", "LENGTHU", "WIDTHU", "HEIGHTU", "ACTIVEU", "IS_BIG_PRODUCTU", "SORT_NOU", "REMARKU", "PRODUCT_CATEGORY_CODEU", "PRODUCT_BREED_CODEU", "PRODUCT_PATTERN_CODEU", "PRODUCT_GRADE_CODEU", "PRODUCT_ORIGIN_CODEU", "YEARU", "WEIGHTU", "PACK_TYPEU", "CREATE_TIMEU", "UPDATE_TIMEU", "ROW_VERSIONU")
values ( '150600002049' ,  '硬盒简化循环烟箱（新版银河）' ,  '0' ,  'YingHeJianHuaXunHuanYanXiangXinBanYinHe' ,  'YHJHXHYXXBYH' ,  '0' ,  '' ,  '' , null,  '0' ,  '0' ,  '0' ,  '0' ,  '1' ,  '0' ,  '0' ,  '' ,  '' ,  '' ,  '' ,  '' ,  '' ,  '' ,  '0', 0 ,  SYSDATE ,  SYSDATE ,  SYS_GUID());

insert into "C##FUSION"."BI_PRODUCTU"("PRODUCT_CODEU", "PRODUCT_NAMEU", "PRODUCT_NOU", "FULL_PHONETICIZEU", "SHORT_PHONETICIZEU", "DISPLAY_ORDERU", "UNIFORM_CODEU", "FACTURER_CODEU", "CARGO_OWNER_CODEU", "ABNORMITYU", "LENGTHU", "WIDTHU", "HEIGHTU", "ACTIVEU", "IS_BIG_PRODUCTU", "SORT_NOU", "REMARKU", "PRODUCT_CATEGORY_CODEU", "PRODUCT_BREED_CODEU", "PRODUCT_PATTERN_CODEU", "PRODUCT_GRADE_CODEU", "PRODUCT_ORIGIN_CODEU", "YEARU", "WEIGHTU", "PACK_TYPEU", "CREATE_TIMEU", "UPDATE_TIMEU", "ROW_VERSIONU")
values ( '03140100100000195' ,  '硬盒简化循环烟箱（天行健）' ,  '0' ,  'YingHeJianHuaXunHuanYanXiangTianXingJian' ,  'YHJHXHYXTXJ' ,  '0' ,  '' ,  '' , null,  '0' ,  '0' ,  '0' ,  '0' ,  '1' ,  '0' ,  '0' ,  '' ,  '' ,  '' ,  '' ,  '' ,  '' ,  '' ,  '0', 0 ,  SYSDATE ,  SYSDATE ,  SYS_GUID());
...
where (( ("PRODUCT_CODEU" =  '03140100100000195' )) AND "UNIT_TYPEU"=1);
...
update "C##FUSION"."BI_PRODUCT_UNITU"
set "DEFAULT_UNITU" =  '1' , "UPDATE_TIMEU" =  SYSDATE , "ROW_VERSIONU" =  SYS_GUID()
where (( ("PRODUCT_CODEU" =  '150600002049' )) AND "UNIT_TYPEU"=1);
...
update "C##FUSION"."BI_PRODUCT_UNITU"
set "DEFAULT_UNITU" =  '1' , "UPDATE_TIMEU" =  SYSDATE , "ROW_VERSIONU" =  SYS_GUID()
where (( ("PRODUCT_CODEU" =  'HQQMGSCYX' )) AND "UNIT_TYPEU"=1);
