...
begin
  FOR I IN 1 .. 40 LOOP
    ...
    values ( 'ProductNameFeedback'||LPAD( I, 2, '0') ,  'ProductInfoSummary' ,  'WCSServer' ,  '产品名称反馈'||LPAD( I, 2, '0')  ,  '11' ,  '28' ,  '1' 
    ,  'DB804.STRING'||((I-1)*28) ,  '产品信息汇总' ,  '1' ,  '1' ,  '1' ,  '0' ,  '1' ,  '0' ,  '' ,  SYSDATE ,  SYSDATE ,  SYS_GUID());
  END LOOP;
  return '^_^';
