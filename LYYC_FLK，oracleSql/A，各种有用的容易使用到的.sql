...
SELECT IDU FROM (
SELECT DISTINCT(TRANSFER_BILL_NOU), IDU, TRANSFER_QUANTITYU FROM WM_MACHINE_HANDOVER_DETAILU WHERE TRANSFER_QUANTITYU=0 ORDER BY TRANSFER_BILL_NOU)); --IDU是表中唯一的
